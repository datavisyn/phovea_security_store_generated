...
export function LoginForm({ onLogin }) {
    ...
    return status === 'success' ? (React.createElement("form", { ref: formRef, className: "form-signin" },
        React.createElement("div", { className: "mb-3" },
            ...
            React.createElement("input", { type: "text", className: "form-control", id: "login_username", name: "username", defaultValue: user.username, placeholder: I18nextManager.getInstance().i18n.t('phovea:security_store_generated.usernamePlaceholder'), required: true, autoComplete: "username", autoFocus: true })),
        React.createElement("div", { className: "mb-3" },
            ...
            React.createElement("input", { type: "text", className: "form-control", id: "login_password", name: "password", defaultValue: user.password, placeholder: I18nextManager.getInstance().i18n.t('phovea:security_store_generated.passwordPlaceholder'), required: true, autoComplete: "current-password" })),
        React.createElement("span", { className: "form-text text-muted" }, I18nextManager.getInstance().i18n.t('phovea:security_store_generated.loginInfo')),
